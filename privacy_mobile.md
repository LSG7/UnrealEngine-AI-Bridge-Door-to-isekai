# Privacy Policy for Door to Isekai (Mobile)

**Last Updated: December 12, 2025** | **Effective Date: January 16, 2025**
...
We do not require you to create an account or register to use our App. Our service operates on an anonymous, session-based model.

### 3.1 Information You Provide
*   **Session ID**: A unique, temporary identifier you enter to connect with the Unreal Engine editor (not stored permanently and linked to no personal profile)
...
*   **Google AdMob**: [AdMob Privacy Policy](https://policies.google.com/privacy)
...
**GitHub Issues**: [https://github.com/LSG7/UnrealEngine-AI-Bridge-Door-to-isekai/issues](https://github.com/LSG7/UnrealEngine-AI-Bridge-Door-to-isekai/issues)
...
*   Flutter: [https://flutter.dev/privacy](https://flutter.dev/privacy)

---

## Intellectual Property Notice
Unreal® is a trademark or registered trademark of Epic Games, Inc. in the United States of America and elsewhere. Unreal® Engine, Copyright 1998 – 2025, Epic Games, Inc. All rights reserved.
