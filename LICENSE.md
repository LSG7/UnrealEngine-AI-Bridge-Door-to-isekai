...
- Connect the plugin to AI services (Claude, ChatGPT, Gemini, etc.) via Model Context Protocol

### Mobile App
- Use the app to activate MCP tools through ad viewing
- Install the app on personal devices
...
**Allowed:**
- Using during development with Claude/ChatGPT to build game features
- Using the MCP server for AI-assisted Blueprints and C++ code generation
- Creating commercial games with AI assistance, then shipping without the plugin

**Not Allowed:**
- Shipping a game that contains UnrealEngine_AI_Bridge plugin files
- Including the MCP server binaries in packaged games
- Distributing apps where end-users can access AI Bridge functionality

### Mobile App (MCP Activation App)

The mobile app is provided for **personal use** to activate MCP tools.
...
- **Mobile App**: Collects minimal data for activation (see Privacy Policy)
...
When using External Services (OpenAI, Anthropic, Google), you are bound by their respective terms:
...
| Mobile App | Personal use | No | N/A |
| Backend | Via API | N/A | N/A |

**For Game Developers:**
- Use freely during development with AI assistance
- Ship commercial games without the plugin
- Don't include plugin binaries in final games
...
- Don't include in commercial course materials without permission
