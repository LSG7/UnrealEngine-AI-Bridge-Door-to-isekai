The AI ​​wrapper method is expensive for consumers, as the wrapper operator makes a profit during the ai communication process.    
...
In the future, I will teach an Unreal-specific Local LLM and offer it for free. Once 'Door to isekai' is completed, it will be possible to train local llm based on it.  
